...
func _physics_process(delta):
	...
	if Input.is_mouse_button_pressed(MOUSE_BUTTON_LEFT):
		...
		var true_laser_level = upgrade_counter.laser_level * upgrade_counter.points_for_upgrade_laser[upgrade_counter.laser_level] + upgrade_counter.laser_level_progress
